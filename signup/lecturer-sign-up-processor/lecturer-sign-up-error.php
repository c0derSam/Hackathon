...
** File name : signup/student-signup-processing/lecturer-sign-up-error.php
...
class signUpErrorPage{
    ...
    public $lecturer_signup_verification_code;

    public function displayErrorPage(){

      session_regenerate_id(true);

      $this->lecturer_signup_verification_code = $_SESSION['lecturer_verification_code'];
      ...
      <br>
            ...
            <div align="center">
                ...
                <div class="alert alert-warning" style="width:300px;">
                   ...
                   <a href="../lecturer/index.php?vcode='.$this->lecturer_signup_verification_code.'">
